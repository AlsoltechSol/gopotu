    ...
    public function index()
    {
        ...
        elseif (Myhelper::hasRole(['deliveryboy'])) {
            ...
            $data['count'] = array(
                ...
                'todayprofits' => (Order::whereIn('status', [ 'delivered'])->whereDate('created_at', Carbon::now())->sum('admin_charge') - Order::whereIn('status', ['received', 'processed', 'accepted', 'intransit', 'outfordelivery', 'delivered'])->whereDate('created_at', Carbon::now())->sum('merchant_total')),
                'monthprofits' => (Order::whereIn('status', [ 'delivered'])->whereMonth('created_at', Carbon::now())->sum('item_total') - Order::whereIn('status', ['received', 'processed', 'accepted', 'intransit', 'outfordelivery', 'delivered'])->whereDate('created_at', Carbon::now())->sum('merchant_total')),
