...
@section('content')
                ...
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <form action="{{route('dashboard.funds.submit')}}" method="POST" id="payoutform">
                            @csrf
                            <input type="hidden" name="type" value="submitpayoutrequest">
    ...
    @if(Myhelper::can('edit_payoutrequest_status'))
...
@push('script')
    <script>
        $('#my-datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('dashboard.fetchdata', ['type' => 'payoutrequests'])}}",
                type: "POST",
                data:function( d )
                {
                    d._token = '{{csrf_token()}}';
        ...
        function view(id){
            Pace.track(function(){
                $.ajax({
                dataType: "JSON",
                    url: "{{route('dashboard.fetchdata', ['type' => 'payoutrequests', 'fetch' => 'single'])}}" + "/" + id,
                    method: "GET",
                    ...
                    success: function(data){
                        ...
                        switch (requestdetails.wallet_type) {
                            case 'branchwallet':
                                wallet_type = 'Merchant Wallet'
                            break;

                            case 'riderwallet':
                                wallet_type = 'Rider Wallet'
                            break;
            ...
            Pace.track(function(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#editstatusform').find('[name="type"]').val("editpayoutrequeststatus");
