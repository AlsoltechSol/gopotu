@section('pageheader', 'Cancel Orders')
@extends('layouts.app')
@section('content')
...
@push('script')
    <script>
        ...
        $('#my-datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('dashboard.fetchdata', ['type' => 'cancel-orders'])}}",
                type: "POST",
                data:function( d )
                {
                    console.log(d);
            ...
            columns:[
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta){
                        if (full.user_cancel_reason !=null){
                            return `Cancellation Reason(User): <br> <b>`+full.user_cancel_reason+`</b><br>\
                            `;
                        }else if(full.mechant_cancellation_reason !=null){
                            return `Cancellation Reason(Merchant): <br> <b>`+full.mechant_cancellation_reason+`</b><br>\
                           
                            `;
                        }else if(full.admin_cancellation_reason !=null){
                            return `Cancellation Reason(Admin): <br> <b>`+full.admin_cancellation_reason+`</b><br>\
                           
                            `;
                        }else{
                            return `Cancellation Reason: <br> <b>`+'N/A'+`</b><br>\
